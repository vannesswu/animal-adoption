...
class AdoptNoteView : BaseView {
    ...
    override func showup() {
        ...
        blackView.addSubview(textView)
        textView.anchor(titleLabel.bottomAnchor, left: titleLabel.leftAnchor, bottom: nil, right: popView.rightAnchor, topConstant: 10, leftConstant: 0, bottomConstant: 0, rightConstant: 0, widthConstant: 0, heightConstant: 350)
